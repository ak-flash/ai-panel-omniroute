...
const WRITABLE_KEYS = [
  'xkiroKey', 'agentrouterKey', 'openrouterKey', 'seloraKey', 'experientialKey', 'agentrouterUserId', 'omniUrl', 'omniUrls', 'omniKey',
...
function registerConfigRoutes(router, {
  ...
  router.add(['GET', 'PUT'], '/api/config', async ({ req, res }) => {
    ...
    const data = {
      ...
      hasExperientialKey: Boolean(s.experientialKey),
